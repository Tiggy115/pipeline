...
def job(t_start, t_end, thread_num, tmp_count):
    ...
    for im_path in ThreadImageList:
        ...
        for i in range(len(tilelist)):
            [tmp_hl, tmp_hvps, tmp_hvp_groups, tmp_z, tmp_z_group, tmp_ls, tmp_z_homo, tmp_hvp_homo, tmp_ls_homo, params] = simon_rectification(tilelist[i], i, inter_Dir, root, tmp_count, im_path)
            hl.append(tmp_hl)
