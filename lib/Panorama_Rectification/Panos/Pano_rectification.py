...
def simon_rectification(img, num, folder, root, tmp_count, name):
    ...
    if plots.hvps:
        ...
        hvps_name = os.path.join(dir,  str(num) + '_im_hvps.jpg')
    ...
    if plots.z:
        ...
        z_name = os.path.join(dir,  str(num) + '_im_z.jpg')
        im_z.save(z_name)
    ...
    if plots.hl:
        ...
        hl_name = os.path.join(dir,  str(num) + '_im_hl.jpg')
        im_hl.save(hl_name)
        ...
        hor_dir = os.path.join(dir, 'horizon_mask')
        if not os.path.exists(hor_dir):
            os.makedirs(hor_dir)
        hl_mask = os.path.join(dir, 'horizon_mask', str(num) + 'hl_msk.jpg')
