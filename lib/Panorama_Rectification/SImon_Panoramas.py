...
for i in range(len(imageList)):
    [tmp_hl, tmp_hvps, tmp_hvp_groups, tmp_z, tmp_z_group, tmp_ls, tmp_z_homo, tmp_hvp_homo, tmp_ls_homo, params] = simon_rectification(imageList[i], i, inter_Dir, root, im_path)
    hl.append(tmp_hl)
